    ...
    <script>
            function load_taxanomy_all()
            {
                    var ajaxUrl = "<?php echo admin_url('admin-ajax.php')?>";
                            ...
                            jQuery('.post_taxanomy').html('<img style="width: 32px;" src="http://demo.smnet.vn/quangcaotaxi/wp-content/uploads/2018/08/ezgif.com-gif-maker.gif" >');
                            jQuery.ajax( {
                                    url: ajaxUrl,
                                    type: 'post',
            ...
            function load_taxanomy(actionName)
            {
                    ...
                    // jQuery("button.taximailinh").on("click",function(){ // When btn is pressed.
                            ...
                            jQuery('.post_taxanomy').html('<img style="margin-left: 49%; width: 32px;" src="http://demo.smnet.vn/quangcaotaxi/wp-content/uploads/2018/08/ezgif.com-gif-maker.gif">');
                            jQuery.ajax( {
                                    url: ajaxUrl,
                                    type: 'post',
        ...
        <script>
                ...
                function load_taxanomy_all_more()
                {
                var ajaxUrl = "<?php echo admin_url('admin-ajax.php')?>";
                        // alert('clicked');
                        ...
                        jQuery.ajax( {
                                ...
                                data : {
                                        action: 'load_post_by_taxanomy_all_more',
                                }

                        }).success(function(posts_taxanomy_all_more){
                                        jQuery(".post_taxanomy").html(posts_taxanomy_all_more); // CHANGE THIS!
