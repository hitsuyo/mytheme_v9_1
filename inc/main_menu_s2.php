...
<script>
    ...
    jQuery(function(){
        ...
        jQuery("div.my-custom-main-menu-class-demo li:has(ul)").on("click",function(){
            ...
            jQuery("ul.sub_menu1",this).slideToggle();
        ...
        jQuery('li.menu-item252 ul.sub_menu1 li.sub_item1 a.anchor_link, li.menu-item237 ul.sub_menu1 li.sub_item1 a.anchor_link, li.menu-item253 ul.sub_menu1 li.sub_item1 a.anchor_link').not(this).on("click",function(e) { 
            // alert('clicked');
            // e.preventDefault();
            jQuery(this).hide();
        });
